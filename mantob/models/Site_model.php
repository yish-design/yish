...
class Site_model extends CI_Model {
	...
	public function add_site($data) {
		...
		CREATE TABLE IF NOT EXISTS `".$this->db->dbprefix($id.'_navigator')."` (
		  ...
		  `imgmain` varchar(255) NOT NULL COMMENT '缩略图',
		  `imgbg` varchar(255) NOT NULL COMMENT '背景图',
		  `mp4` varchar(255) NOT NULL COMMENT 'mp4',
		  `flv` varchar(255) NOT NULL COMMENT 'flv',
		  `webm` varchar(255) NOT NULL COMMENT 'webm',
		  `ogv` varchar(255) NOT NULL COMMENT 'ogv',
		  `words` varchar(255) NOT NULL COMMENT 'words',
		  `css` varchar(255) NOT NULL COMMENT 'css',
