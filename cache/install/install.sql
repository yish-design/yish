DROP TABLE IF EXISTS `{dbprefix}member_invite`;
CREATE TABLE IF NOT EXISTS `{dbprefix}member_invite` (
...
REPLACE INTO `{dbprefix}member_group` VALUES(1, '待审核会员', 'default', 'default', 0.00, 1, 1, 0, 0, 0, '', '', 'default', 0);
REPLACE INTO `{dbprefix}member_group` VALUES(2, 'OAuth会员', 'default', 'default', 0.00, 0, 0, 0, 0, 0, '', '', 'default', 0);
REPLACE INTO `{dbprefix}member_group` VALUES(3, '普通会员', 'default', 'default', 0.00, 1, 1, 3, 0, 1, '', '', 'default', 0);
REPLACE INTO `{dbprefix}member_group` VALUES(4, '商业会员', 'default', 'default', 10.00, 2, 1, 3, 1, 1, '', '', 'default', 0);
