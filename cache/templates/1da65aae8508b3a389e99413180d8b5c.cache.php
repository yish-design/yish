...
.showMsg h5{
	background-image: url("<?php echo SITE_URL; ?>mantob/statics/images/msg.png");background-repeat: no-repeat; color:#fff; padding-left:35px; height:25px; line-height:26px;*line-height:28px; overflow:hidden; font-size:14px; text-align:left;
}
.showMsg .content{ 
...
<div class="showMsg" style="text-align:center">
    ...
    <div class="bottom">
    <?php if ($url) { ?>
    <a href="<?php echo $url; ?>">如果您的浏览器没有跳转，请单击这里哦</a>
